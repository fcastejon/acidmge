...
*/
/*
 * ParsimonyCubeEvalUmbral
 * 
 * Evaluates a cube root function circuit including parsimony
 * 
...
import es.uned.simda.acidge.problema.dev.eval.kozamat.KozaGaussianEval;
import es.uned.simda.acidge.spice.SigItem;
import es.uned.simda.acidge.spice.Signal;
import es.uned.simda.acidge.ge.GEProperties;

public class ParsimonyCubeRootEvalUmbral extends ComputaEval 
{
	private final static Logger logger = Logger.getLogger(ParsimonyCubeRootEvalUmbral.class.getName());
	...
	public ParsimonyCubeRootEvalUmbral(GEProperties geproperties) 
	{
		super(geproperties);
		logger.info("ParsimonyCubeRootEvalUmbral:" + TERCIO + ":" + error[iMax]);
	}
