 ...
 * 
 * Evaluates a cubing function circuit including parsimony
 * 
...
public class ParsimonyCubeEvalUmbral extends ComputaEval 
{
	private final static Logger logger = Logger.getLogger(ParsimonyCubeEvalUmbral.class.getName());
	...
	public ParsimonyCubeEvalUmbral(GEProperties geproperties) 
	{
		super(geproperties);
		logger.info("ParsimonyCubeEvalUmbral:" + error[iMax]);
	}
