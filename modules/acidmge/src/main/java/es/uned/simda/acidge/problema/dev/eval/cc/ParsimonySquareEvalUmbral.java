...
*/
/*
 * ParsimonySquareEvalUmbral
 * 
 * Evaluates a squaring function circuit including parsimony
 * 
...
public class ParsimonySquareEvalUmbral extends ComputaEval 
{
	private final static Logger logger = Logger.getLogger(ParsimonySquareEvalUmbral.class.getName());
	...
	public ParsimonySquareEvalUmbral(GEProperties geproperties) 
	{
		super(geproperties);
		logger.info("ParsimonySquareEvalUmbral:" + error[iMax]);
	}
