...
public class TestGeneradorMultiNetlistTopology 
{
	private final static Logger logger = Logger.getLogger(TestGeneradorMultiNetlistTopology.class.getName());
	final static String newLine = String.format("%n");
	final static String GRAMMARTEST1 = "testMultiNetlistComputaTopology1.ebnf";
	final static String GRAMMARTEST2 = "testMultiNetlistComputaTopology2.ebnf";
