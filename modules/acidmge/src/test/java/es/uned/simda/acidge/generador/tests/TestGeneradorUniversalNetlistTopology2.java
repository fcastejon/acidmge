...
*/
/*
 * TestCase para probar la clase Generador y la gramática testUniversalNetlistMOSFETTopology.ebnf
 */
...
public class TestGeneradorUniversalNetlistTopology2 
{
	private final static Logger logger = Logger.getLogger(TestGeneradorUniversalNetlistTopology2.class.getName());
	final static String newLine = String.format("%n");
	final static String GRAMMARTEST1 = "testUniversalNetlistMOSFETTopology.ebnf";
	...
	String expected1 = 
		"R 2 0 nulo2 3.3e4 nulo1" + newLine +
		"* Fin" + newLine;

	String expected2 = 
		"R 2 3 nulo2 1.1e2 nulo2" + newLine +
		"M 6 7 8 0 NMOS1 L=10u W=167u" + newLine +
		"M 9 10 11 4 PMOS1 L=10u W=11u" + newLine +
