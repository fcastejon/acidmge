...
public class TestParsimonyVoltRefEval
{
	private final static Logger logger = Logger.getLogger(TestParsimonyVoltRefEval.class.getName());
	...
	private static double expected[] = { 0.046429, 0.034524, 0.022619, 16.7 };
	private static int expectedHits[] = { 105, 105, 105, 51 };
	private static int componentCount[] = { 39, 29, 19, 30 };
	...
	{	
		VoltRefEval eval = new ParsimonyVoltRefEval(null);
