 ...
 *
 */
public class TestCruce1PasoGE2 
{
	private final static Logger logger = Logger.getLogger(TestCruce1PasoGE2.class.getName());
	...
	public static void checkEA()
	{
	    ...
	    //cruce = opf.creaOperadorRecombinacion(8, 0.7, 1, 0, 0.0, 0.1, 0.0, 120, randomMock);
		cruce = new Cruce1PasoGE2(8, 0.7, 1, 0, 0.0, 0.1, 120, randomMock);
	}
	...
	public void test9() 
	{
		...
		motor(genes2, 48, genes3, 6, dbl, in, expected1, expected2);
	}
