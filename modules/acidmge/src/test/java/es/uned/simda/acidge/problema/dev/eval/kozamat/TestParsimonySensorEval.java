...
public class TestParsimonySensorEval
{
	private final static Logger logger = Logger.getLogger(TestParsimonySensorEval.class.getName());
	...
	private static double expected[] = { 0.232143, 0.172619, 105.0, 55.5 };
	...
	{	
		SensorEval eval = new ParsimonySensorEval(null);
