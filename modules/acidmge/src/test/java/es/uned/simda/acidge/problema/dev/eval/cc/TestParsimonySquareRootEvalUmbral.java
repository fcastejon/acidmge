...
public class TestParsimonySquareRootEvalUmbral
{
	private final static Logger logger = Logger.getLogger(TestParsimonySquareRootEvalUmbral.class.getName());
	...
	private static double expected[] = { 0.016414979, 0.012206010, 0.008417938, 2.9698484, 1.414213562 };
	...
	{	
		...
		DevEval eval = new ParsimonySquareRootEvalUmbral(geproperties);
