...
*/
/*
 * TestCase para probar la clase CruceBloquesGE2
 */
 ...
 *
 */
public class TestCruceBloquesGE2 
{
	private final static Logger logger = Logger.getLogger(TestCruceBloquesGE2.class.getName());
	...
	public static void checkEA()
	{
	    ...
	    //cruce = opf.creaOperadorRecombinacion(7, 0.7, 1, 6, 0.0, 0.0, 0.0, 120, randomMock);
		cruce = new CruceBloquesGE2(7, 0.7, 1, 6, 0.0, 120, randomMock);
	}
	...
	public void test7() 
	{
		...
		motor(genes1, 18, genes2, 18, dbl, in, expected1, expected2);
	}
	...
	public void test8() 
	{
		...
		motor(genes1, 0, 1, genes2, 0, 2, dbl, in, expected1, expected2);
	}
...
*/				
		...
		motor(genes3, 48, genes4, 54, dbl, in, expected1, expected2);
	}
