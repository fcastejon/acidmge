...
*/
/*
 * TestCase para probar la clase ParsimonyGaussianEval
 * 
 */
...
public class TestParsimonyGaussianEval
{
	private final static Logger logger = Logger.getLogger(TestParsimonyGaussianEval.class.getName());
	...
	private static double expected[] = { 0.011607, 0.008631, 19.715099, 5.225 };
	private static int expectedHits[] = { 101, 101, 54, 50 };
	private static int componentCount[] = { 39, 29, 30, 30 };
	...
	{	
		DevEval eval = new ParsimonyGaussianEval(null);
