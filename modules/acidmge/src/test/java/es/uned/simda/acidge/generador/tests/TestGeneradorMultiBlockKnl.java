...
public class TestGeneradorMultiBlockKnl 
{
	private final static Logger logger = Logger.getLogger(TestGeneradorMultiBlockKnl.class.getName());
	final static String newLine = String.format("%n");
	final static String GRAMMARTEST1 = "testMultiKnl1.ebnf";
	final static String GRAMMARTEST2 = "testMultiKnl2.ebnf";
	...
	public void test1() 
	{
		...
		byte genes[] = { 5, 7, 13, 8, 
				31, 2, 3, 4, 2, 2, 1, 1, 6, 7, 8, 9, 
				15, 34, 7, 23, 92, 115, 3, 22, 31, 48, 14, 78, 
				92, 21, 62, 23, 24, 32, 92, 1, 31, 56, 27, 88, 
				19, 31, 15, 23, 7, 84, 32, 13, 32, 34, 73, 48, 51, 32
				};
