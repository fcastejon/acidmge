...
public class TestParsimonyCubeRootEvalUmbral
{
	private final static Logger logger = Logger.getLogger(TestParsimonyCubeRootEvalUmbral.class.getName());
	...
	private static double expected[] = { 0.014624084, 0.010874319, 0.007499530, 2.6458342, 1.25992105 };
	...
	{	
		...
		DevEval eval = new ParsimonyCubeRootEvalUmbral(geproperties);
