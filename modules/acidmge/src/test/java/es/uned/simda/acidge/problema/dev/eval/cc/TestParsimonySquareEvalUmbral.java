...
public class TestParsimonySquareEvalUmbral
{
	private final static Logger logger = Logger.getLogger(TestParsimonySquareEvalUmbral.class.getName());
	...
	private static double expected[] = { 0.001450893, 0.001078869, 0.000744048, 2.625e-1, 1.25e-1 };
	...
	{	
		...
		DevEval eval = new ParsimonySquareEvalUmbral(geproperties);
