...
*/
/*
 * TestCase para probar la clase Generador y la gramática testUniversalNetlistSensorTopology.ebnf
 */
...
public class TestGeneradorUniversalNetlistTopology 
{
	private final static Logger logger = Logger.getLogger(TestGeneradorUniversalNetlistTopology.class.getName());
	final static String newLine = String.format("%n");
	final static String GRAMMARTEST1 = "testUniversalNetlistSensorTopology.ebnf";
